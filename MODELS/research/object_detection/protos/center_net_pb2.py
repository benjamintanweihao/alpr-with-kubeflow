...
_CENTERNET_OCCUPANCYNETMASKPREDICTION = _descriptor.Descriptor(
  name='OccupancyNetMaskPrediction',
  full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='classification_loss', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.classification_loss', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='num_samples', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.num_samples', index=1,
      number=2, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dim', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.dim', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=256,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='task_loss_weight', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.task_loss_weight', index=3,
      number=4, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='mask_stride', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.mask_stride', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='concat_features', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.concat_features', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='concat_clip', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.concat_clip', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mask_prob_threshold', full_name='object_detection.protos.CenterNet.OccupancyNetMaskPrediction.mask_prob_threshold', index=7,
      number=8, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0.5),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CENTERNET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='occupancy_net_mask_prediction', full_name='object_detection.protos.CenterNet.occupancy_net_mask_prediction', index=10,
  ...
  nested_types=[_CENTERNET_OBJECTDETECTION, _CENTERNET_OBJECTCENTERPARAMS, _CENTERNET_KEYPOINTESTIMATION, _CENTERNET_MASKESTIMATION, _CENTERNET_DENSEPOSEESTIMATION, _CENTERNET_TRACKESTIMATION, _CENTERNET_OCCUPANCYNETMASKPREDICTION, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_CENTERNET_OCCUPANCYNETMASKPREDICTION.fields_by_name['classification_loss'].message_type = object__detection_dot_protos_dot_losses__pb2._CLASSIFICATIONLOSS
_CENTERNET_OCCUPANCYNETMASKPREDICTION.containing_type = _CENTERNET
...
_CENTERNET.fields_by_name['occupancy_net_mask_prediction'].message_type = _CENTERNET_OCCUPANCYNETMASKPREDICTION
...
CenterNet = _reflection.GeneratedProtocolMessageType('CenterNet', (_message.Message,), dict(
  ...
  OccupancyNetMaskPrediction = _reflection.GeneratedProtocolMessageType('OccupancyNetMaskPrediction', (_message.Message,), dict(
    DESCRIPTOR = _CENTERNET_OCCUPANCYNETMASKPREDICTION,
    __module__ = 'object_detection.protos.center_net_pb2'
    # @@protoc_insertion_point(class_scope:object_detection.protos.CenterNet.OccupancyNetMaskPrediction)
    ))
  ,
...
_sym_db.RegisterMessage(CenterNet.OccupancyNetMaskPrediction)
